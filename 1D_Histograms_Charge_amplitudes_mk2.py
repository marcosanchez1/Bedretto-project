'''
In this script I'll just compute the histograms of the charge distributions for both channels so far I've been just working
with channel 0 and 1 so I'll just stick to that.
...
def main():
    ...
    df = pd.read_csv(f".\\Data\\Processed_data\\1Bar_2Chs\\Run_{voltage}V_Run{run}_Data_3_{day}_2026_Ascii.csv")
